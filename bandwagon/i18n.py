...
STRINGS = {
    "ko": {
        ...
        "preset_export_btn": "내보내기…",
        "preset_import_btn": "가져오기…",
        "preset_export_dialog_title": "마커 프리셋 내보내기",
        "preset_import_dialog_title": "마커 프리셋 가져오기",
        "preset_csv_filter": "CSV 파일 (*.csv)",
        "preset_export_success": "{n}개 프리셋을 저장했습니다.",
        "preset_export_error": "저장하지 못했습니다: {err}",
        "preset_import_success": "{n}개 프리셋을 불러왔습니다.",
        "preset_import_error": "CSV 파일을 읽지 못했습니다: {err}",
        "preset_import_empty": "가져올 수 있는 프리셋이 CSV 안에 없습니다.",
        ...
        "toolbar_composite_import_tip": "이미 내보낸 .bwcomposite 파일을 열어 밴드 분석을 시작합니다.",
        ...
        "toolbar_check_updates": "업데이트 확인...",
        "update_title": "BandWagon 업데이트",
        "update_checking": "GitHub에서 최신 버전을 확인하는 중입니다...",
        "update_check_failed": "업데이트 확인 실패",
        "update_current": "현재 v{version}이 최신 버전입니다.",
        "update_available": "BandWagon {version} 업데이트가 있습니다.",
        "update_current_version": "현재 버전",
        "update_new_version": "새 버전",
        "update_installer": "설치 파일",
        "update_package": "업데이트 파일",
        "update_size_unknown": "크기 정보 없음",
        "update_asset_pending": "등록 대기 중",
        "update_release_notes": "변경 내용",
        "update_no_notes": "변경 기록이 없습니다.",
        "update_later": "나중에",
        "update_release_page": "릴리스 페이지",
        "update_download_install": "다운로드 및 설치",
        "update_no_installer": "이 릴리스에는 아직 Windows 설치 파일이 없습니다.",
        "update_no_portable": "이 릴리스에는 아직 포터블 ZIP 파일이 없습니다.",
        "update_no_checksum": "설치 파일 무결성 정보가 없어 앱에서는 자동 설치하지 않습니다.",
        "update_downloading": "업데이트 설치 파일을 다운로드하는 중입니다...",
        "update_progress": "{completed:.1f} MB / {total} · {speed:.1f} MB/s",
        "update_verified": "다운로드와 SHA-256 검증을 마쳤습니다.",
        "update_download_failed": "업데이트 다운로드 실패",
        "update_cancelling": "다운로드를 취소하는 중입니다...",
        "update_install_title": "업데이트 설치",
        "update_install_prompt": "BandWagon을 종료하고 업데이트 설치를 시작할까요?",
        "update_ready_later": "업데이트가 준비되었습니다. 나중에 다시 업데이트를 확인해 설치할 수 있습니다.",
        "update_launch_failed": "업데이트 실행 실패",
        "zoom_out": "축소",
        "zoom_in": "확대",
        ...
        "composite_intro": "가시광 사진(마커가 보이는 일반 사진)과 UV 사진(밴드가 보이는 형광 사진)을 코너 4점으로 정렬해 합성합니다.\n합성 결과를 .bwcomposite 파일로 내보내면 바로 밴드 분석을 시작할 수 있습니다. 이미 만들어둔 파일이 있다면 아래 '기존 합성 파일 불러오기'로 바로 여세요.",
    ...
    "en": {
        ...
        "preset_export_btn": "Export…",
        "preset_import_btn": "Import…",
        "preset_export_dialog_title": "Export Marker Presets",
        "preset_import_dialog_title": "Import Marker Presets",
        "preset_csv_filter": "CSV Files (*.csv)",
        "preset_export_success": "Saved {n} preset(s).",
        "preset_export_error": "Could not save the file: {err}",
        "preset_import_success": "Imported {n} preset(s).",
        "preset_import_error": "Could not read the CSV file: {err}",
        "preset_import_empty": "No presets found in that CSV.",
        # GelView / ProfileView / StdCurveView
        ...
        "toolbar_composite_import_tip": "Open a .bwcomposite file you already exported and start band analysis.",
        ...
        "update_title": "BandWagon Update",
        "update_checking": "Checking GitHub for the latest version...",
        "update_check_failed": "Update Check Failed",
        "update_current": "You are running the latest version, v{version}.",
        "update_available": "BandWagon {version} is available.",
        "update_current_version": "Current version",
        "update_new_version": "New version",
        "update_installer": "Installer",
        "update_package": "Update package",
        "update_size_unknown": "Size unknown",
        "update_asset_pending": "Not uploaded yet",
        "update_release_notes": "Release notes",
        "update_no_notes": "No release notes are available.",
        "update_later": "Later",
        "update_release_page": "Release page",
        "update_download_install": "Download and Install",
        "update_no_installer": "This release does not yet include a Windows installer.",
        "update_no_portable": "This release does not yet include a portable ZIP package.",
        "update_no_checksum": "The installer has no integrity digest, so the app will not install it automatically.",
        "update_downloading": "Downloading the update installer...",
        "update_progress": "{completed:.1f} MB / {total} · {speed:.1f} MB/s",
        "update_verified": "Download and SHA-256 verification completed.",
        "update_download_failed": "Update Download Failed",
        "update_cancelling": "Cancelling the download...",
        "update_install_title": "Install Update",
        "update_install_prompt": "Quit BandWagon and start the update installer?",
        "update_ready_later": "The update is ready. Check for updates again later to install it.",
        "update_launch_failed": "Update Launch Failed",
        "zoom_out": "Out",
        "zoom_in": "In",
        ...
        "composite_intro": "Align a visible-light photo (showing markers) with a UV photo (showing fluorescent bands) using 4 corner points, then blend them.\nExporting the result as a .bwcomposite file lets you start band analysis right away. Already have a file? Use 'Load Existing Composite File' below.",
