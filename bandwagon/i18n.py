...
STRINGS = {
    "ko": {
        ...
        "warp_detect_fail_small_msg": "충분히 큰 젤 영역을 찾지 못했습니다.\n",
        ...
        # 합성 탭
        "tab_wb": "합성",
        "wb_intro": "가시광 사진(마커가 보이는 일반 사진)과 UV 사진(밴드가 보이는 형광 사진)을 정렬해 합성합니다.\n빈 썸네일을 클릭해 두 사진을 불러오세요.",
        ...
        "wb_btn_apply": "합성 결과를 메인 이미지로 적용",
        "wb_apply_hint": "적용하면 화면에는 합성(블렌드) 이미지가 보이고, 밴드 분석은 UV 신호만으로 계산됩니다. 이후 레인 지정·분석은 평소와 동일하게 진행하면 됩니다.",
        ...
        "status_wb_applied": "합성이 적용되었습니다 — 분석은 UV 신호 기준입니다.",
    ...
    "en": {
        ...
        "warp_detect_fail_small_msg": "Couldn't find a large enough gel area.\n",
        ...
        "splash_tab_wb": "Loading composite tools...",
        ...
        # Composite tab
        "tab_wb": "Composite",
        "wb_intro": "Align and blend a visible-light photo (showing markers) with a UV photo (showing fluorescent bands).\nClick an empty thumbnail to load each photo.",
        ...
        "wb_btn_apply": "Apply Composite as Main Image",
        "wb_apply_hint": "After applying, the screen shows the blended composite, while band analysis is computed from UV signal only. Lane assignment and analysis then work exactly as usual.",
        ...
        "status_wb_applied": "Composite applied — analysis is based on UV signal.",
